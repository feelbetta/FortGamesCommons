...
public class JoinSign implements GameSign {

    public static final String[] SIGN_FORMAT = new String[]{

            "[Join]",
            " ",
            "{map}", //the map
            "{players} Players" //the player's inside
    };
    ...
    public JoinSign(@Nonnull MiniFortGame game, @Nonnull BlockPosition position) {
    ...
    public void onClick(@Nonnull FortPlayer fortPlayer, @Nonnull JoinableObjectAction joinableObjectAction) {
        ...
        this.game.onJoin(Objects.requireNonNull(fortPlayer, "fortPlayer"));
    }
